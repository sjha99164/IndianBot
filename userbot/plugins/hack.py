...
async def _(event):
    ...
    if event.reply_to_msg_id:
        ...
        if idd==532281165:
            await event.edit("This is My Master\nI can't hack my master's Account\n**How dare you trying to hack my master's account nigger!**\n\n__Your account has been hacked! Pay 6969696969$ to my master__ [Iam Shubham](tg://user?id=532281165) __to release your account__😏")
        else:
